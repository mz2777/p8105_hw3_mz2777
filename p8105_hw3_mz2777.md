...
**Comment:** the mean data value in different states mostly distribute
between 15-30 from 2002 to 2010. The mean data value of state WV is
lower than 15 in 2005 and 2009. The mean data value of state IN is lower
than 15 in 2007.
...
There is no trend apparently based on the line plot. On Tuesday,
Wednesday and Thursday, the variaty of activity counts is smaller than
the other days.
...
**Conclusion**: On Wednesday and Tuesday, this patient’s activity counts
are lower relatively which may show that he did not do much activity on
those two days, while on weekend, the activity counts is relatively
high. In each day, we can see that this patients usually sleep after
midnight and the sleeping time is about 5 hours which is very short. On
Friday, he usually have high activity counts around 20:00 to 21:00. On
weekends, the activity counts is high during 10:00 to 12:00.
