...
**Comment:** There is no trend apparently based on the plot. On
Thursday, the total activity counts decresed.
...
accel_data %>% 
  ...
  scale_color_viridis(option = "magma", name = "Day", discrete=TRUE) + 
  theme_bw()
```
